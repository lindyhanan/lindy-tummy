...
// PASTIKAN IMPORT BINDING INI SINKRON DENGAN NAMA LAYOUT KAMU
import com.example.lindy_tummy.databinding.FragmentTabQrCodeBinding
import com.google.zxing.BarcodeFormat
import com.google.zxing.EncodeHintType
import com.google.zxing.qrcode.QRCodeWriter

class TabQrCodeFragment : Fragment() { // Namamu saat ini TabQrCodeFragment

    // Gunakan kelas binding yang digenerate oleh fragment_tab_qrcode.xml
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnGenerate.setOnClickListener {
            ...
            if (text.isEmpty()) {
                binding.edtQrInput.error = "Teks tidak boleh kosong!"
